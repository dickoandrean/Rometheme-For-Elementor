...
class Offcanvas_Rometheme extends \Elementor\Widget_Base
{
    ...
    public function get_elementor_template()
    {
        ...
        if ($template->have_posts()) {
            while ($template->have_posts()) {
                $template->the_post();
                $list[intval(get_the_ID())] = esc_html__(get_the_title(), 'romethemekit-plugin');
            }
        }
        return $list;
    }
    ...
    protected function register_controls()
    {
        $this->start_controls_section('content-section', [
            'label' => esc_html__('Menu Content', 'romethemekit-plugin'),
            'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
        ]);
        $this->add_control('menu-select', [
            'label' => esc_html__('Select Template', 'romethemekit-plugin'),
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => esc_html__('**You create from elementor template first', 'romethemekit-plugin'),
            ]
        );

        $this->add_control('icon-select', [
            'label' => esc_html__('Menu Icon', 'romethemekit-plugin'),
        ...
        $this->start_controls_section('style-section', [
            'label' => esc_html__('Style Setting', 'romethemekit-plugin'),
        ...
        $this->start_controls_tab('menu-tab-normal', ['label' => esc_html__('Normal',  'romethemekit-plugin')]);
        $this->add_control('button-background', [
            'label' => esc_html__('Menu Button Background', 'romethemekit-plugin'),
        ...
        $this->start_controls_tab('menu-tab-hover', ['label' => esc_html__('Hover',  'romethemekit-plugin')]);
        ...
        $this->start_controls_section('offcanvas_setting', [
            'label' => esc_html__('Offcanvas Setting', 'romethemekit-plugin'),
            'tab' => \Elementor\Controls_Manager::TAB_STYLE
        ]);
        ...
        $this->add_control('offcanvas-position', [
            'label' => esc_html__('Offcanvas Position', 'romethemekit-plugin'),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'right' => 'Right',
                'left' => 'Left',
        ...
        $this->add_responsive_control('responsive-width-offcanvas', [
            'label' => esc_html__('Width Offcanvas Menu', 'romethemekit-plugin'),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => ['px', '%'],
            'range' => [
                'px' => [
        ...
        $this->start_controls_section('offcanvas-close', [
            'label' => esc_html__('Offcanvas Close Button', 'romethemekit-plugin'),
            'tab' => \Elementor\Controls_Manager::TAB_STYLE
        ]);

        $this->add_control('close-icon', [
            'label' => esc_html__('Icon', 'romethemekit-plugin'),
            'type' => \Elementor\Controls_Manager::ICONS,
        ...
        $this->add_responsive_control('margin-close', [
            'label' => esc_html__('Margin', 'romethemekit-plugin'),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'size_units' => ['px', '%', 'em', 'rem'],
            'selectors' => [
        ...
        $this->start_controls_tab('offcanvas-close-normal', ['label' => esc_html__('Normal', 'romethemekit-plugin')]);
        ...
        $this->add_group_control(
            \Elementor\Group_Control_Border::get_type(),
            [
                'name' => esc_html__('border-close', 'romethemekit-plugin'),
                'selector' => '{{WRAPPER}} .rkit-offcanvas-close',
            ]
        );
        $this->end_controls_tab();

        $this->start_controls_tab('offcanvas-close-hover', ['label' => esc_html__('Hover', 'romethemekit-plugin')]);
